...
- CommandExecutor feature disabling. This feature enables execution of certain commands by registering token handlers for text received via serial, websocket or telnet connection. If this feature is not used additional RAM/Flash can be obtained by setting DISABLE_CMD_EXEC=1. This will save ~1KB RAM and ~3KB of flash memory.
</p></details>
