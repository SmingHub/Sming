...
- Debug information for custom lwip: If you use custom lwip(see above) some debug information will be printed for critical erros and situations. You can disable debug information printing alltogether using ENABLE_LWIPDEBUG=0 To increase debugging for certain areas you can modify debug options in third-party/esp-open-lwip/include/lwipopts.h
