...
unsigned long Sparkfun_L6470::accCalc(float stepsPerSecPerSec)
{
...
float Sparkfun_L6470::accParse(unsigned long stepsPerSecPerSec)
{
...
// This is a 12-bit value, so we need to make sure the value is at or below 0xFFF.
unsigned long Sparkfun_L6470::decCalc(float stepsPerSecPerSec)
{
  float temp = stepsPerSecPerSec * 0.137438;
  if( (unsigned long) long(temp) > 0x00000FFF) return 0x00000FFF;
  else return (unsigned long) long(temp);
...
float Sparkfun_L6470::decParse(unsigned long stepsPerSecPerSec)
{
    return (float) (stepsPerSecPerSec & 0x00000FFF) / 0.137438;
}
...
unsigned long Sparkfun_L6470::maxSpdCalc(float stepsPerSec)
{
...
float Sparkfun_L6470::maxSpdParse(unsigned long stepsPerSec)
{
...
// This is a 12-bit value, so we need to make sure the value is at or below 0xFFF.
unsigned long Sparkfun_L6470::minSpdCalc(float stepsPerSec)
{
...
float Sparkfun_L6470::minSpdParse(unsigned long stepsPerSec)
{
...
unsigned long Sparkfun_L6470::FSCalc(float stepsPerSec)
{
...
float Sparkfun_L6470::FSParse(unsigned long stepsPerSec)
{
...
unsigned long Sparkfun_L6470::intSpdCalc(float stepsPerSec)
{
  float temp = stepsPerSec * 4.1943;
...
float Sparkfun_L6470::intSpdParse(unsigned long stepsPerSec)
{
...
unsigned long Sparkfun_L6470::spdCalc(float stepsPerSec)
{
...
float Sparkfun_L6470::spdParse(unsigned long stepsPerSec)
{
...
unsigned long Sparkfun_L6470::paramHandler(byte param, unsigned long value)
{
...
unsigned long Sparkfun_L6470::xferParam(unsigned long value, byte bitLen)
{
