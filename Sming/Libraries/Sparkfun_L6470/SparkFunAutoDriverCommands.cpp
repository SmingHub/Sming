...
//  the dSPIN chip.
void Sparkfun_L6470::setParam(byte param, unsigned long value)
{
  param |= SET_PARAM;
  SPIXfer((byte)param);
...
//  the dSPIN chip.
unsigned long Sparkfun_L6470::getParam(byte param)
{
...
void Sparkfun_L6470::stepClock(byte dir)
{
...
void Sparkfun_L6470::move(byte dir, unsigned long numSteps)
{
  SPIXfer(MOVE | dir);
...
void Sparkfun_L6470::goTo(long pos)
{
  SPIXfer(GOTO);
...
void Sparkfun_L6470::goToDir(byte dir, long pos)
{
...
void Sparkfun_L6470::goUntil(byte action, byte dir, float stepsPerSec)
{
...
//  for act.
void Sparkfun_L6470::releaseSw(byte action, byte dir)
{
...
//  ABS_POS values.
void Sparkfun_L6470::setMark(long newMark)
{
  setParam(MARK, newMark);
}

void Sparkfun_L6470::setPos(long newPos)
{
...
uint8_t Sparkfun_L6470::getStatus()
{
  int temp = 0;
