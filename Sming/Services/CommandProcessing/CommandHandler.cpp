...
void CommandHandler::registerSystemCommands()
{
	...
	registerCommand(CommandDelegate(F("status"), F("Displays System Information"), system,
									CommandFunctionDelegate(&CommandHandler::procesStatusCommand, this)));
	registerCommand(CommandDelegate(F("echo"), F("Displays command entered"), system,
									CommandFunctionDelegate(&CommandHandler::procesEchoCommand, this)));
	registerCommand(CommandDelegate(F("help"), F("Displays all available commands"), system,
									CommandFunctionDelegate(&CommandHandler::procesHelpCommand, this)));
	registerCommand(CommandDelegate(F("debugon"), F("Set Serial debug on"), system,
									CommandFunctionDelegate(&CommandHandler::procesDebugOnCommand, this)));
	registerCommand(CommandDelegate(F("debugoff"), F("Set Serial debug off"), system,
									CommandFunctionDelegate(&CommandHandler::procesDebugOffCommand, this)));
	registerCommand(CommandDelegate(F("command"), F("Use verbose/silent/prompt as command options"), system,
