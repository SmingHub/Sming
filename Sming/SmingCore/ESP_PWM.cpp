 ...
 */
#include "../SmingCore/ESP_PWM.h"
#include "../SmingCore/Clock.h"
#include "../Wiring/WiringFrameworkIncludes.h"

ESPPWM::ESPPWM(uint8_t* pins, int no_of_pins) {
    if (no_of_pins > 0) {
 ...
 */
uint8_t ESPPWM::getChannel(uint8_t pin)
{
 ...
 */
void ESPPWM::analogWrite(uint8_t pin, uint32 duty)
{
 ...
 * Parameters: pin -Esp8266 pin number
 */
uint32 ESPPWM::getDuty(uint8 pin)
{
 ...
 */
void ESPPWM::setDuty(uint32 duty, uint8 pin)
{
 ...
 * 				Period / frequency will remain same for all pins.
 */
void ESPPWM::setPeriod(uint32 period)
{
