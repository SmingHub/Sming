...
LIBS		= microc gcc hal phy pp net80211 openlwip wpa main sming
...
OBJ		:= $(patsubst %.o,$(BUILD_BASE)/%.o,$(CXX_OBJ)) $(shell find $(SMING_HOME)/out/build -type f -name '*.o')
# OBJ_SM := $(shell find $(SMING_HOME)/out/build -type f -name '*.o')
...
$1/%.o: %.cpp
	...
	$(vecho) $(CXX) $(INCDIR) $(MODULE_INCDIR) $(EXTRA_INCDIR) $(SDK_INCDIR) $(CXXFLAGS) -c $$< -o $$@
endef
...
$(TARGET_OUT): $(APP_AR)
	$(vecho) "LD $@"
	$(vecho) $(LD) -L$(USER_LIBDIR) -L$(SDK_LIBDIR) $(LD_SCRIPT) $(LDFLAGS) -Wl,--start-group $(LIBS) $(APP_AR) -Wl,--end-group -o $@
