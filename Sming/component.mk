...
COMPONENT_CXXFLAGS		+= -DHTTP_SERVER_EXPOSE_NAME=$(HTTP_SERVER_EXPOSE_NAME)

COMPONENT_VARS			+= HTTP_SERVER_EXPOSE_VERSION
HTTP_SERVER_EXPOSE_VERSION ?= 0
COMPONENT_CXXFLAGS		+= -DHTTP_SERVER_EXPOSE_VERSION=$(HTTP_SERVER_EXPOSE_VERSION)

COMPONENT_VARS			+= HTTP_SERVER_EXPOSE_DATE
HTTP_SERVER_EXPOSE_DATE ?= 0
COMPONENT_CXXFLAGS		+= -DHTTP_SERVER_EXPOSE_DATE=$(HTTP_SERVER_EXPOSE_DATE)
