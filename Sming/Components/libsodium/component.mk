...
COMPONENT_CFLAGS := -DSODIUM_STATIC -DHAVE_C_VARARRAYS=1 -DNATIVE_LITTLE_ENDIAN=1 -DHAVE_INLINE_ASM=1 -DHAVE_WEAK_SYMBOLS=1 -DHAVE_ALLOCA_H=1 -DHAVE_ALLOCA=1 -DCONFIGURED=1
