...
enum llhttp_errno {
  HTTP_ERRNO_OK = 0,
  HTTP_ERRNO_INTERNAL = 1,
  HTTP_ERRNO_STRICT = 2,
  HTTP_ERRNO_LF_EXPECTED = 3,
  HTTP_ERRNO_UNEXPECTED_CONTENT_LENGTH = 4,
  HTTP_ERRNO_CLOSED_CONNECTION = 5,
  HTTP_ERRNO_INVALID_METHOD = 6,
  HTTP_ERRNO_INVALID_URL = 7,
  HTTP_ERRNO_INVALID_CONSTANT = 8,
  HTTP_ERRNO_INVALID_VERSION = 9,
  HTTP_ERRNO_INVALID_HEADER_TOKEN = 10,
  HTTP_ERRNO_INVALID_CONTENT_LENGTH = 11,
  HTTP_ERRNO_INVALID_CHUNK_SIZE = 12,
  HTTP_ERRNO_INVALID_STATUS = 13,
  HTTP_ERRNO_INVALID_EOF_STATE = 14,
  HTTP_ERRNO_INVALID_TRANSFER_ENCODING = 15,
  HTTP_ERRNO_CB_MESSAGE_BEGIN = 16,
  HTTP_ERRNO_CB_HEADERS_COMPLETE = 17,
  HTTP_ERRNO_CB_MESSAGE_COMPLETE = 18,
  HTTP_ERRNO_CB_CHUNK_HEADER = 19,
  HTTP_ERRNO_CB_CHUNK_COMPLETE = 20,
  HTTP_ERRNO_PAUSED = 21,
  HTTP_ERRNO_PAUSED_UPGRADE = 22,
  HTTP_ERRNO_PAUSED_H2_UPGRADE = 23,
  HTTP_ERRNO_USER = 24,
  HTTP_ERRNO_CR_EXPECTED = 25,
  HTTP_ERRNO_CB_URL_COMPLETE = 26,
  HTTP_ERRNO_CB_STATUS_COMPLETE = 27,
  HTTP_ERRNO_CB_HEADER_FIELD_COMPLETE = 28,
  HTTP_ERRNO_CB_HEADER_VALUE_COMPLETE = 29,
  HTTP_ERRNO_UNEXPECTED_SPACE = 30,
  HTTP_ERRNO_CB_RESET = 31,
  HTTP_ERRNO_CB_METHOD_COMPLETE = 32,
  HTTP_ERRNO_CB_VERSION_COMPLETE = 33,
  HTTP_ERRNO_CB_CHUNK_EXTENSION_NAME_COMPLETE = 34,
  HTTP_ERRNO_CB_CHUNK_EXTENSION_VALUE_COMPLETE = 35,
  HTTP_ERRNO_CB_PROTOCOL_COMPLETE = 38
};
...
enum llhttp_status {
  ...
  HTTP_STATUS_CODE_RESPONSE_IS_STALE = 110,
  HTTP_STATUS_CODE_REVALIDATION_FAILED = 111,
  HTTP_STATUS_CODE_DISCONNECTED_OPERATION = 112,
  HTTP_STATUS_CODE_HEURISTIC_EXPIRATION = 113,
  HTTP_STATUS_CODE_MISCELLANEOUS_WARNING = 199,
  ...
  HTTP_STATUS_CODE_TRANSFORMATION_APPLIED = 214,
  HTTP_STATUS_CODE_IM_USED = 226,
  HTTP_STATUS_CODE_MISCELLANEOUS_PERSISTENT_WARNING = 299,
  ...
  HTTP_STATUS_CODE_PAGE_EXPIRED = 419,
  HTTP_STATUS_CODE_ENHANCE_YOUR_CALM = 420,
  ...
  HTTP_STATUS_CODE_REQUEST_HEADER_FIELDS_TOO_LARGE_UNOFFICIAL = 430,
  ...
  HTTP_STATUS_CODE_BLOCKED_BY_PARENTAL_CONTROL = 450,
  HTTP_STATUS_CODE_UNAVAILABLE_FOR_LEGAL_REASONS = 451,
  HTTP_STATUS_CODE_CLIENT_CLOSED_LOAD_BALANCED_REQUEST = 460,
  HTTP_STATUS_CODE_INVALID_X_FORWARDED_FOR = 463,
  HTTP_STATUS_CODE_REQUEST_HEADER_TOO_LARGE = 494,
  HTTP_STATUS_CODE_SSL_CERTIFICATE_ERROR = 495,
  HTTP_STATUS_CODE_SSL_CERTIFICATE_REQUIRED = 496,
  HTTP_STATUS_CODE_HTTP_REQUEST_SENT_TO_HTTPS_PORT = 497,
  HTTP_STATUS_CODE_INVALID_TOKEN = 498,
  HTTP_STATUS_CODE_CLIENT_CLOSED_REQUEST = 499,
  ...
  HTTP_STATUS_CODE_WEB_SERVER_UNKNOWN_ERROR = 520,
  HTTP_STATUS_CODE_WEB_SERVER_IS_DOWN = 521,
  HTTP_STATUS_CODE_CONNECTION_TIMEOUT = 522,
  HTTP_STATUS_CODE_ORIGIN_IS_UNREACHABLE = 523,
  HTTP_STATUS_CODE_TIMEOUT_OCCURED = 524,
  HTTP_STATUS_CODE_SSL_HANDSHAKE_FAILED = 525,
  HTTP_STATUS_CODE_INVALID_SSL_CERTIFICATE = 526,
  HTTP_STATUS_CODE_RAILGUN_ERROR = 527,
  HTTP_STATUS_CODE_SITE_IS_OVERLOADED = 529,
  HTTP_STATUS_CODE_SITE_IS_FROZEN = 530,
  HTTP_STATUS_CODE_IDENTITY_PROVIDER_AUTHENTICATION_ERROR = 561,
